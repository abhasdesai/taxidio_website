...
<body onload="document.getElementById('customerData').submit();">
	<?php echo form_open($this->lang->lang().'/package/ccavRequestHandler',array('name'=>'customerData','id'=>'customerData')); ?>
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				<tr>
					<td>Parameter Name(Package Purchased):</td><td><?php echo $package_details->package_name;?></td>
					<td>Parameter Value(No Of Travel Guides You Can Download):</td><td><?php echo $package_details->package_qty;?></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="188710"/></td>
				</tr>
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo uniqid(); ?>"/></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?php echo number_format((float)$order['totalbill'], 2, '.', ''); ?>"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="<?php echo site_url($this->lang->lang().'/package/returnurl') ?>"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="<?php echo site_url(); ?>"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?php echo $this->session->userdata('name');?>"/></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?php echo $this->session->userdata('email');?>"/></td>
		        </tr>
		        <tr>
