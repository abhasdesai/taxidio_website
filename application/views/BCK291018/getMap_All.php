              ...
              for (i = 0; i < data.features.length; i++) {
                ...
                else
                {
                  ...
                  if(currentFeature.isselected==0)
                  {
                      ...
                      linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addAttraction(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                  }
                  ...
                  if(currentFeature.isselected==1)
                  {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteAttraction(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                 }
      ...
      stop: function (event, ui) { ui.item.unbind("click.prevent"); },
        ...
        update: function (event, ui) {
              ...
              $.ajax({
                  ...
                  type: 'POST',
                  url: '<?php echo site_url("saveSingleCountryXOrder") ?>',
                  beforeSend: function(){
                     $.LoadingOverlay("show");
                  },
                  complete: function(){
