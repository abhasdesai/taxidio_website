		...
		<tbody>
			...
			<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);">
				<div style="font-size: 15px; text-align: left;">
  				<p>Dear <?php echo $this->session->userdata('name').','; ?></p>
  				<p><h3>Your Password had Been Changed!</h3></p>
  				<p>This Email confirms that your Password has been changed.</p>
  				<p style="font-size: 15px; text-align: left;">Regards,<br/>Taxidio Travel India Pvt. Ltd.</p>
  				</div>
			</td>
			</tr>
		</tbody>
