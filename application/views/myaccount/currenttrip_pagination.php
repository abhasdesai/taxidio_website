                                    ...
                                    <tbody>
                                        ...
                                        <tr class="trip-list">
                                            ...
                                            <td>
                                             ...
                                             <td class="q-n-r middle-align"><a href="<?php echo site_url('planned-itinerary-forum').'/'.$list['slug'] ?>"><?php echo str_pad($list['total'], 2, '0', STR_PAD_LEFT); ?></a></td>
                                             <?php }else{ ?>
                                               <td class="q-n-r middle-align"><?php echo 'N/A'; ?></td>
                                             <?php } ?>
                                             <td class="q-n-r middle-align">
                                ...
                                <div class="alert alert-info">
                                     There are no on-going trips right now.
                                </div>
                                <?php } ?> 
