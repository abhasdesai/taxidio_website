          ...
          <tbody>
            <tr>
              <td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);"><div style="font-size: 15px; text-align: left;">
                  ...
                  <p>Your trip <span style="color: #f58634">“</span><strong style="color: #4e356b;"><?php echo $user_trip_name; ?></strong><span style="color: #f58634">”</span> will start tomorrow. We wish you a happy journey.
                  </p>
                  <p style="text-align: center;margin-bottom: 35px;">
                  <a href="<?php echo site_url(); ?>" target="_blank">www.taxidio.com</a>
                  </p>
                <p>
                  <span style="color:#3e3b3b;font-family:Helvetica;font-size:14px">Love,</span><br>
                  <span style="color:#3e3b3b;font-family:Helvetica;font-size:14px">Taxidio.</span>
                </p>
                </div></td>
            </tr>
            <tr>
