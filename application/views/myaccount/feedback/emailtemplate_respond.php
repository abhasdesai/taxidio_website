		...
		<tbody>
			...
			<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);">
				<div style="font-size: 15px; text-align: center;">
  				...
  				<p>We have received your message and would like to thank you for writing to us. If your inquiry is urgent, please use the telephone number listed below, to talk to one of our staff members. Otherwise, we will reply by email shortly.</p>
  				</div>
				<p style="font-size: 15px; text-align: left;">Talk to you soon,<br/>Taxidio Travel India Pvt. Ltd.</p>
  			</td>
			</tr>
		</tbody>
			</table>
