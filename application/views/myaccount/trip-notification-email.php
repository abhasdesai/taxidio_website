          ...
          <tbody>
            <tr>
              <td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);"><div style="font-size: 15px; text-align: left;">
                  ...
                  <p>Your trip <span style="color: #f58634">“</span><strong style="color: #4e356b;"><?php echo $user_trip_name; ?></strong><span style="color: #f58634">”</span> will start after 15 days.
                  </p>
