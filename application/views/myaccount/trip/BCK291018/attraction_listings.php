    ...
    <div class="row">
        ...
        <div class="col-md-12">
           ...
           <?php if(count($otherCities)){ ?>
            ...
            <a href="javascript:void(0);" class="link-button checkadd" onClick="addCity('<?php echo string_encode($country) ?>')">Add New City</a>
           <?php } ?>

           <?php /*if(isset($basic['travelguide']) && $basic['travelguide']!=''){ */?>
               <a data-toggle="modal" data-target="#pkgpurchase" id="travelguidea" class="link-button travel-guide" href="javascript:void(0)"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download Travel Guide</a>
            <?php /*}else{ ?>
   ...
   <div class="row">
          ...
          <ul id="sortable" class="savedsingleountry-x">
            ...
            <?php if(count($attractioncities)>1){ ?>
                <span class="delete-city" onClick="removeSavedSingleCountryCity('<?php echo string_encode($combination) ?>')"><a href="javascript:void(0);">
         ...
         <input type="hidden" id="coid" value="<?php echo $countryid; ?>"/>
...
<div id="bindTab">
        <div class="sidebar col-md-4 scrollbar-inner">
             <div id='listings' class='listings saveSingleListing'></div>
            </div>
           ...
           <div class="col-md-12 inner-links">
            ...
            <div class="col-md-4 attractions-btn">
              ...
              <div class="col-md-4 attractions-btn">
              <a id="showallSingleSaved" idattr="<?php echo md5($attractioncities[0]['id']); ?>" class="link-button modal-link" href="javascript:void(0);"><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
              </div>
              <div class="col-md-4 attractions-btn">
			...
			<?php if($this->session->userdata('fuserid') != ''){?>
			  ...
			  <div class="col-md-12 inner-links">
				...
				<div class="col-md-4 attractions-btn">
					...
					<?php }else{?>
						<a class="link-button modal-link" href="<?php echo site_url('download-guide').'/'.$citypostid ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download Travel Guide</a>
					<?php }?>
...
<div id="mapModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php echo form_open('',array('id'=>'addUserActivityToSingleCountrySaved')); ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
     ...
     ?>
      ...
      <?php echo form_open('',array('id'=>'addNewCityFormSaved')); ?>
