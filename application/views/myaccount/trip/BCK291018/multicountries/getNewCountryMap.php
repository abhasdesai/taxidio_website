              ...
              <div class="sidebar col-md-4 scrollbar-inner">
                 ...
                 <div class="col-md-12 inner-links">
                  <div class="text-left">
                   ...
                   <div class="col-md-4 attractions-btn">
                    <a id="showmultiallSaved" idattr="<?php echo $cityid; ?>" class="link-button modal-link" href="javascript:void(0);"><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
                   </div>
...
<script>
  ...
  $(document).ready(function(){
          ...
          if(secretid!='')
          {
              if($("#hotellink").length)
              {
                 var url='<?php echo site_url("hotelListsForSavedMultiCountry") ?>/'+secretid;
...
$("#ckkMultiSaved").click(function(){
  ...
  function funOpen(id)
  {
   ...
   $("#showmultiallSaved").click(function(){
     var iti='<?php echo $itineraryid; ?>';
     $.ajax({
        url: '<?php echo site_url("getAllAttractionsOfMultiCitySaved") ?>',
        type: 'POST',
    ...
    $('#listings').sortable({
            ...
            update: function (event, ui) {
                  ...
                  $.ajax({
                      ...
                      type: 'POST',
                      url: '<?php echo site_url("saveMultiOrderSaved") ?>',
                      beforeSend: function(){
                         $.LoadingOverlay("show");
                      },
                      complete: function(){
