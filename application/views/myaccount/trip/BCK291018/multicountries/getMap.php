<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  <div class="text-left">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showmultiallSaved" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
    </div>
    <div class="col-md-4 attractions-btn">
