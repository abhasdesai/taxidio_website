...
<div class="container searchcity-btn addcity-btn search-travelguide">
    <div class="row">
        ...
        <?php if(isset($basic['travelguide']) && $basic['travelguide']!=''){ ?>
               <a id="travelguidea" class="link-button travel-guide travelguidea" href="<?php echo site_url('userfiles/travelguide').'/'.$basic['travelguide'] ?>" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Download Travel Guide</a>
              <?php } ?>
