...
<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  ...
  <div class="col-md-4 attractions-btn">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showallSearchedSaved" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
    </div>
<div class="col-md-4 attractions-btn">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
          ...
          $(document).on('click','.popupclose',function(e){
            ...
            var cityimage='<?php if(isset($cityimage) && $cityimage!=""){ echo $cityimage; }else{ echo "0"; }  ?>';
            if(cityimage!=0)
            {
          ...
          if(secretid!='')
          {
              if($("#hotellink").length)
              {
                 var url='<?php echo site_url("hotelListsForsearchedCity") ?>/'+secretid;
                 $("#hotellink").attr('href',url);
              }
          }

          var param='<?php if(isset($param) && $param!=""){ echo $param; }else{ echo ""; } ?>'
          if(param!=0)
          {
            $("#attrlink").attr('href',param);
          }
