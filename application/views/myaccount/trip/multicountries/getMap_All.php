...
<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  <div class="text-left">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showMy" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View Recommendations</a>
    </div>
    <div class="col-md-4 attractions-btn">
    <a class="link-button modal-link" href="<?php echo site_url('updatesave-multi-itinerary').'/'.$secretkey; ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Save</a>
    </div>
...
<script type="text/javascript">
            ...
            function buildLocationList(data) {
              for (i = 0; i < data.features.length; i++) {
                ...
                if(currentFeature.properties.isplace==1)
                {
                  ...
                  {
                     if(currentFeature.isselected==1)
                     {
               ...
               if(currentFeature.properties.tag_star==1 || currentFeature.properties.tag_star==2)
                {
                  ...
                  {
                    link.innerHTML = '<span class="starattraction"><i class="fa fa-star" aria-hidden="true"></i></span><span class="placenm">'+prop.name+'</span><span class="paidattraction"><i class="fa fa-usd" aria-hidden="true"></i></span>';
                  }
                  else
                  {
                    link.innerHTML = '<span class="starattraction"><i class="fa fa-star" aria-hidden="true"></i></span><span class="placenm">'+prop.name+'</span>';
                  }
                }
                else
                {
                  if(currentFeature.properties.ispaid==1)
                  {
                    link.innerHTML = '<span class="placenm">'+prop.name+'<span><span class="paidattraction"><i class="fa fa-usd" aria-hidden="true"></i></span>';
                  }
                  else
                  {
                  ...
                  if(currentFeature.isselected==0)
                  {
                      ...
                      linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addSavedMultiMainAttractionAll(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                  }
                  ...
                  if(currentFeature.isselected==1)
                  {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteSavedMultiMainAttractionAll(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                 }
  ...
  $(document).ready(
  function() {
     $( "#listings" ).draggable({ disabled: true });
   }
  );
    ...
    $( "#sortable" ).sortable({
        ...
        update: function (event, ui) {
              ...
              $.ajax({
                  ...
                  type: 'POST',
                  url: '<?php echo site_url("savedMultiCountryXOrder") ?>',
                  beforeSend: function(){
                     $.LoadingOverlay("show");
                  },
                  complete: function(){
