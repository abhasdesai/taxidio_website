...
<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  <div class="text-left">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showallSingleSaved" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View Recommendations</a>
    </div>
    <div class="col-md-4 attractions-btn">
 ...
 if(currentFeature.properties.tag_star==1 || currentFeature.properties.tag_star==2)
                ...
                else
                {
                  ...
                  if(currentFeature.isselected==0)
                  {
                      ...
                      linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addAttractionSaved(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                  }
                  ...
                  if(currentFeature.isselected==1)
                  {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteAttractionSaved(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                 }
