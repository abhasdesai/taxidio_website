...
<div class="container searchcity-btn addcity-btn search-travelguide">
    <div class="row">
        ...
        <?php if(isset($basic['travelguide']) && $basic['travelguide']!=''){ ?>
               <a id="travelguidea" class="link-button travel-guide travelguidea" href="<?php echo site_url('userfiles/travelguide').'/'.$basic['travelguide'] ?>" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Purchase Travel Guide</a>
              <?php } ?>
 ...
 <div class="inner-mainview container">
   ...
   <div class="row">
          ...
          <ul id="sortable" class="savedSearchcity-x">
            ...
            <?php if($isaddordelete==1){ ?>

            <li id="drag-x-<?php echo $c-1; ?>" class="ui-state-default drag-x <?php if($c==count($attractioncities)){ echo 'active-li'; } ?>"><a href="javascript:void(0);" onclick="funOpen('<?php echo md5($list['id']) ?>')"><?php echo $list['city_name']; ?></a>
       ...
       <div class="col-md-12 inner-links">
        <div class="text-left">
         <div class="col-md-4 attractions-btn">
          ...
          <div class="col-md-4 attractions-btn">
          <a id="showallSearchedSaved" idattr="<?php echo $cityid; ?>" class="link-button modal-link" href="javascript:void(0);"><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
          </div>
           <div class="col-md-4 attractions-btn">
...
<script type="text/javascript">
  ...
  function funOpen(id)
  {
   ...
   $("#showallSearchedSaved").click(function(){
    var iti='<?php echo $itineraryid; ?>';
     $.ajax({
        url: '<?php echo site_url("getAllAttractionsOfSingleCitySaved") ?>',
        type: 'POST',
  ...
  $( "#sortable" ).sortable({
      ...
      update: function (event, ui) {
            ...
            $.ajax({
                data: data+'&iti='+iti,
                type: 'POST',
                url: '<?php echo site_url("savedSearchedCityXOrder") ?>',
                beforeSend: function(){
                   $.LoadingOverlay("show");
                },
                complete: function(){
...
$("#singlemodelsaved").click(function(){
  $("#addNewActivitySingleFormSaved")[0].reset();
  $("#isall").val(0);
 $('#mapModal').modal({
    backdrop: 'static',
    keyboard: false });
