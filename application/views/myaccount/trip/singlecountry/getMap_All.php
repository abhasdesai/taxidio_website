...
<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  ...
  <div class="col-md-4 attractions-btn">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showMySearchedSaved" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View Recommendations</a>
    </div>
    <div class="col-md-4 attractions-btn">
             ...
             function buildLocationList(data) {
              for (i = 0; i < data.features.length; i++) {
                ...
                if(currentFeature.isselected==0)
                {
                    ...
                    linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addInnerAttractionSingleSaved(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                }
                ...
                if(currentFeature.isselected==1)
                {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteInnerAttractionSingleSaved(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                }
...
$("#showMySearchedSaved").click(function(){
  var iti='<?php echo $itineraryid; ?>';
  $.ajax({
        url: '<?php echo site_url("getUserAttractionsOfSingleCountrySaved") ?>',
        type: 'POST',
