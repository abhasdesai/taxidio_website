...
<html>
<head>
  <title>Share Itinerary with Member</title>
</head>
<body>
          ...
          <tbody>
            <tr>
              <td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);"><div style="font-size: 15px; text-align: left;">
                  <p> Hey <?php echo ucwords($name); ?>,</p>
                  
                  <p>Take a look at our trip itinerary <span style="color: #f58634">“</span><strong style="color: #4e356b;"><?php echo $user_trip_name; ?></strong><span style="color: #f58634">”</span>. Sign in, go to <span style="color: #f58634">“</span><strong style="color: #4e356b;">My Account ->  Invited Trips</strong><span style="color: #f58634">”</span> and accept the invitation to access the itinerary.<br><br>
                  </p>
