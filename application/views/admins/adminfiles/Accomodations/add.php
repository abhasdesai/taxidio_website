<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Accomodations/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Accomodation</label>
							<input type="text" id="accomodation_type" name="accomodation_type" class="form-control required" maxlength="150" value="<?php echo set_value('accomodation_type') ?>" autocomplete="off"/>
