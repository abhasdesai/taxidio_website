<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Traveltimeslots/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-3">
						  <div class="form-group">
							<label>From</label>
							<input type="text" id="travel_time_slot_from" name="travel_time_slot_from" class="form-control required number" maxlength="11" value="<?php echo set_value('travel_time_slot_from') ?>" autocomplete="off"/>
					...
					<div class="col-md-3">
						  <div class="form-group">
							<label>To</label>
							<input type="text" id="travel_time_slot_to" name="travel_time_slot_to" class="form-control number" maxlength="11" value="<?php echo set_value('travel_time_slot_to') ?>" autocomplete="off"/>
