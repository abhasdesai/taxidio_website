<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Seo/Topcities/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
							 ...
							 <label>City</label>
								<select name="city_id" class="required select2 form-control" id="city_id">
									...
									<?php foreach ($countries as $list) {?>
										<option value="<?php echo $list['id'] ?>"  <?php echo set_select('city_id', $list['id']); ?> ><?php echo $list['city_name'] ?></option>
									<?php }?>
								</select>
              ...
              <table>
				<tr>
					...
					<td><a href="<?php echo site_url('admins/Seo/Topcities') ?>" class="btn btn-block btn-default" >Cancel</a></td><td>&nbsp;</td>
				</tr>
			</table>
