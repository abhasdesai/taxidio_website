<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Budgets/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-3">
						  <div class="form-group">
							<label>From <i class="fa fa-inr" aria-hidden="true"></i></label>
							<input type="text" id="budget_hotel_per_night_from" name="budget_hotel_per_night_from" class="form-control required" maxlength="11" value="<?php echo set_value('budget_hotel_per_night_from') ?>" autocomplete="off"/>
					 ...
					 <div class="col-md-3">
						  <div class="form-group">
							...
							<input type="text" id="budget_hotel_per_night_to" name="budget_hotel_per_night_to" class="form-control required" maxlength="11" value="<?php echo set_value('budget_hotel_per_night_to') ?>" autocomplete="off"/>
