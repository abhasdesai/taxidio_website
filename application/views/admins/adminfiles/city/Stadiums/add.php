...
<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
		   ...
		   <a href="<?php echo site_url('admins/city/Cities'); ?>" class="btn bg-navy margin">Back to Cities</a>
            ...
            <div class="box-body">
				<?php echo form_open('admins/city/Stadiums/add/'.$city_id, array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Stadium</label>
							<input type="hidden" name="city_id" value="<?php echo $city_id ?>"/>
							<input type="text" id="searchTextField" name="stadium_name" class="form-control required" maxlength="200" value="<?php echo set_value('stadium_name') ?>" autocomplete="off" placeholder=""/>
				 ...
				 <div class="row">
					 <div class="col-md-12">
						  <div class="form-group">
							<label>Details</label>
							<textarea name="stadium_description" class="form-control" rows="8"><?php echo set_value('ras_description') ?></textarea>
					...
					<div class="col-md-12">
						  <div class="form-group">
							...
							<select name="knownfor[]" class="required form-control select2" multiple>
								...
								<?php if(in_array($list['id'], $def)){ echo 'selected'; } ?>><?php echo $list['tag_name']; ?></option>
								<?php } ?>
							</select>
				 ...
				 <div class="row">
					...
					<div class="col-md-6">
						  <div class="form-group">
							<label>Address</label>
							<textarea name="stadium_address" class="form-control required" rows="4" maxlength="800"><?php echo set_value('stadium_address') ?></textarea>
				  ...
				  <div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							...
							<input type="text" id="stadium_lat" name="stadium_lat" class="form-control required number" value="<?php echo set_value('stadium_lat') ?>" autocomplete="off"/>
					 ...
					 <div class="col-md-6">
						  <div class="form-group">
							...
							<input type="text" id="stadium_long" name="stadium_long" class="form-control required number" value="<?php echo set_value('stadium_long') ?>" autocomplete="off"/>
				 ...
				 <div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Contact</label>
							<input type="text" id="stadium_contact" name="stadium_contact" class="form-control" maxlength="100" value="<?php echo set_value('stadium_contact') ?>" autocomplete="off"/>
					 ...
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Website</label>
							<input type="text" id="stadium_website" name="stadium_website" class="form-control url" maxlength="300" value="<?php echo set_value('stadium_website') ?>" autocomplete="off"/>
				  ...
				  <div class="row">
					 <div class="col-md-4">
						  <div class="form-group">
							...
							<textarea name="stadium_timing" class="form-control" rows="6" maxlength="1000"><?php echo set_value('stadium_timing') ?></textarea>
				   ...
				   <div class="form-group">
                     <label>
                   Get Your Guide ?
                       <input type="radio" name="stadium_get_your_guide" class="minimal" value="1" >&nbsp;Yes&nbsp;
                     </label>
                     <label>
                       <input type="radio" name="stadium_get_your_guide" class="minimal" value="0" checked>&nbsp;No&nbsp;
                     </label>
                </div>
  ...
  <table>
				<tr>
					...
					<td><a href="<?php echo site_url('admins/city/Stadiums/index').'/'.$city_id  ?>" class="btn btn-block btn-default" >Cancel</a></td><td>&nbsp;</td>
				</tr>
			</table>
