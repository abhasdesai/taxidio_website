          ...
          <div class="box box-default">
            ...
            <div class="box-header">
				...
				<div class="pull-right marrgt20">
					<a class="btn btn-block btn-info btnadd" href="<?php echo site_url('admins/city/Restaurants/add').'/'.$id; ?>">Add New</a>
                </div>
            <div class="box-body">
...
<script type="text/javascript" charset="utf-8">
	...
	function confirm_delete(id,city_id) {
	  ...
	  var value= confirm('Are you sure you want to delete this Restaurant ?');

	  if(value)
	  {
		 window.location = '<?php echo site_url("admins/city/Restaurants/delete") ?>'+"/"+id+"/"+city_id;
	  }
	}
	...
	{
		    var value = "<a href='<?php echo site_url('admins/city/Restaurants/edit') ?>"+'/'+data+"' title='' data-placement='top' data-toggle='tooltip' data-original-title='Edit'><span class='glyphicon glyphicon-edit'></span></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:void(0);' onclick='confirm_delete("+data+","+row[5]+");' title='' data-placement='top' data-toggle='tooltip' data-original-title='Delete'><span class='glyphicon glyphicon-remove'></span></a>  ";
			return value;
	}
	...
	function renderwebsite(data, type, row){
		...
		$(document).ready(function()
		{
				...
				$('#example1').dataTable({
						...
						"bServerSide": true,
						"sServerMethod": "POST",
						"sAjaxSource": "<?php echo site_url('admins/city/Restaurants/getTable') ?>"+"/"+id,
						"sAjaxDataProp": "data",
