          ...
          <div class="box box-default">
            ...
            <div class="box-header">
				...
				<div class="pull-right marrgt20">
					<a class="btn btn-block btn-info btnadd" href="<?php echo site_url('admins/Hoteltypes/add'); ?>">Add New</a>
                </div>
            <div class="box-body">
...
<script type="text/javascript" charset="utf-8">
	...
	function confirm_delete(id) {
	  ...
	  var value= confirm('Are you sure you want to delete this Hotel Type ?');

	  if(value)
	  {
		 window.location = '<?php echo site_url("admins/Hoteltypes/delete") ?>'+"/"+id;
	  }
	}
	    ...
	    return data;
			...
			$(document).ready(function()
			{
				$('#example1').dataTable({
						...
						"bServerSide": true,
						"sServerMethod": "POST",
						"sAjaxSource": "<?php echo site_url('admins/Hoteltypes/getTable') ?>",
						"sAjaxDataProp": "data",
