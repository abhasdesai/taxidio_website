<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Continents/edit/' . $id, array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<input type="hidden" name="id" value="<?php echo $id; ?>"/>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Continent</label>
							<input type="text" id="continent_name" name="continent_name" class="form-control required" maxlength="200" value="<?php echo $continent['continent_name']; ?>" autocomplete="off"/>
