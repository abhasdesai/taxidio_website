<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Months/edit/' . $id, array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<input type="hidden" name="id" value="<?php echo $id; ?>"/>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Month</label>
							<input type="text" id="month_name" name="month_name" class="form-control required" maxlength="12" value="<?php echo $month['month_name'] ?>" autocomplete="off"/>
