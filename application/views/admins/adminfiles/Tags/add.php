<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Tags/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Tag</label>
							<input type="text" id="tag_name" name="tag_name" class="form-control required" maxlength="200" value="<?php echo set_value('tag_name') ?>" autocomplete="off"/>
