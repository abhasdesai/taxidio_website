<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Days/add', array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Days</label>
							<input type="text" id="days_range" name="days_range" class="form-control required" maxlength="11" value="<?php echo set_value('days_range') ?>" autocomplete="off"/>
