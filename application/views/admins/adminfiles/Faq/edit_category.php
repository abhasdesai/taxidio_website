<section class="content">
		<?php if ($this->session->flashdata('success')) {?>
            ...
            <div class="box-body">
				<?php echo form_open('admins/Faq/edit_category/' . $id, array('id' => 'form1', 'enctype' => 'multipart/form-data')); ?>
				<input type="hidden" name="id" value="<?php echo $id; ?>"/>
				<div class="row">
					 <div class="col-md-6">
						  <div class="form-group">
							<label>Category</label>
							<input type="text" id="category" name="category" class="form-control required" maxlength="100" value="<?php echo $category['category'] ?>" autocomplete="off"/>
