		...
		<tbody>
			...
			<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);">
				<div style="font-size: 15px; text-align: left;">
  				...
  				<p>
						Thank you for registering with <a href="<?php echo site_url() ?>">taxidio.com.</a>
					</p>
					<p>
						We promise to take care of all your travel needs. Feel free to <a href="<?php echo site_url('contactus'); ?>">contact us</a> anytime.
					</p>
					<p style="font-size: 15px; text-align: left;">Love,<br/>Team Taxidio.</p>
  			</td>
			</tr>
			<tr style="width: 100%;">
