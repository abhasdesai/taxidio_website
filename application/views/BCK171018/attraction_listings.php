    ...
    <div class="col-md-12">
      ...
      <ul class="button-ul">
        ...
        <?php } ?>
         ...
         <li><a target="_blank" href="https://www.partner.viator.com/en/67434/search/<?php echo $slug; ?>" class="link-button ">Viator<i class="fa fa-hand-o-right" aria-hidden="true"></i></a></li>
