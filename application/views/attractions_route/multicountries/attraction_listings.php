 ...
 <div class="inner-mainview container">
  ...
  <div class="row">
          ...
          <?php for($i=0;$i<count($countries)-1;$i++){ ?>
              <li class="<?php if($i==0){ echo 'main-li-active'; } ?>" id="<?php echo 'multi'.$i ?>" onClick="getDataForNewCountry(this.id,'<?php echo md5($countries[$i]['country_id']);?>')">
           ...
           <div class="col-md-12 inner-links">
            <div class="text-left">
             ...
             <?php if($this->session->userdata('fuserid')!=''){ ?>
              ...
              <a class="link-button modal-link" href="<?php echo site_url('save-multi-itinerary').'/'.$this->uri->segment(2) ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Save</a>
      ...
      <?php if(count($otherCities)){ ?>
          ...
          <div class="row">
              <div class="control-group">
                  <label class="control-label" for="Save"></label>
                  <div class="controls">
                    <input type="submit" class="action-button shadow animate blue" id="btnaddcity" value="Add" />
          ...
          <?php }else{ ?>
            <h3>we do not have any other city for this country</h3>
          <?php } ?>
         </div> 
         <?php echo form_close(); ?>
      </div>
