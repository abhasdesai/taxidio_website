<div class="sidebar col-md-4">
 ...
 <div class="col-md-12 inner-links">
  <p class="text-left">
    ...
    <a id="showallSingle" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
  </p>
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
          ...
          // This will let you use the .remove() function later on
            ...
            directions.addWaypoint(2, [72.82671690000006,19.1130535]);
            directions.addWaypoint(3, [72.87537139999995,19.1692907]);
            directions.addWaypoint(4, [72.84456,19.00263]);
            directions.addWaypoint(5, [72.82015990000002,19.1194644]);
            directions.addWaypoint(6, [72.85085040000001,19.0402084]);
            directions.addWaypoint(7, [72.86048359999995,19.1738427]);
            directions.setDestination([72.86048359999995,19.1738427]);
