...
<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  ...
  <div class="col-md-4 attractions-btn">
    ...
    <div class="col-md-4 attractions-btn">
    <a id="showall" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
    </div>
    <div class="col-md-4 attractions-btn">
    <?php if($this->session->userdata('fuserid')!=''){ ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
          ...
          if(secretid!='')
          {
              if($("#hotellink").length)
              {
                 var url='<?php echo site_url("showHotels") ?>/'+secretid;
