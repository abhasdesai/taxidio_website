		...
		<tbody>
			...
			<td align="left" valign="top" style="font-family: Arial,Helvetica,sans-serif; font-size: 13px; color: rgb(0, 0, 0);">
				<div style="font-size: 15px; text-align: left;">
					...
					<p>Thank you for subscribing to our Newsletter and Chronicles, where we take you around the globe with our words.</p>
					<p>Hope you enjoy reading them as much as we loved writing them for you.</p>
  				</div>
