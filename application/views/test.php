    ...
    <div class="row margin-0">
      ...
      <div class="col-md-3 five-column">
        <div class="form-group">
            ...
            <label for="traveltime">Travel Time (In Hours)</label>
      ...
      <div class="col-md-3 five-column">
        <div class="form-group">
            ...
            <label for="amount">Temprature</label>
      ...
      <div class="col-md-3 five-column">
        <div class="form-group">
          ...
          <label for="accomodation">Budget Per Night (USD)</label>
            <input type="text" class="range-style" id="accomodation" readonly style="border:0; color:#f6931f; font-weight:bold;">
            <div id="accomodation-range" class="sliding-range-style"></div>
       </div>
      </div>
