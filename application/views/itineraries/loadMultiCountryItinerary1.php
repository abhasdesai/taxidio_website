 ...
 <div class="inner-mainview container">
  ...
  <div class="row">
          ...
          <?php for($i=0;$i<count($countries)-1;$i++){  ?>
              <li class="<?php if($i==0){ echo 'main-li-active'; echo " style='pointer-events: none;'"; } ?>" id="<?php echo 'multi'.$i ?>" onClick="getNewCountryDataFromitinerary('<?php echo $countries[$i]['country_id'];?>',<?php echo $itineraryid ?>,this.id)">
