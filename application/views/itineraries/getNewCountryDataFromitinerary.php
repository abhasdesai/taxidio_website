...
<?php } ?>
 ...
 <div class="row">
          ...
          <ul id="sortable" class="iti-sortable">
     ...
     <?php } ?>
      ...
      <div id="bindTab">
              <div class="sidebar col-md-4 scrollbar-inner">
                   <div id='listings' class='listings hideicons'></div>
                  </div>
...
$("#showLogonForm").click(function(){
  ...
  function funOpen(id)
  {
     ...
     $.ajax({
          type:'POST',
          url:'<?php echo site_url("getPublicSavedMulticountryCityAttractions") ?>',
  ...
  /*function getNewCountryDataFromitinerary(id)
  {

      $.ajax({
           type:'POST',
           url:'<?php echo site_url("getNewCountryDataFromitinerary") ?>',
           data:'countryid='+id+'&iti='+'<?php echo $itineraryid ?>',
           beforeSend: function(){
              $.LoadingOverlay("show");
           },
           complete: function(){
