           ...
           <div class="col-md-12 inner-links">
            ...
            <div class="col-md-4 attractions-btn">
             ...
             <div class="col-md-4 attractions-btn">
              ...
              <a id="showall" idattr="<?php echo $cityid; ?>" class="link-button modal-link" href="javascript:void(0);"><i class="fa fa-plus-circle" aria-hidden="true"></i>View All</a>
              </div>
              <div class="col-md-4 attractions-btn">
...
$(document).ready(function(){
    ...
    var coid='<?php if(isset($countryid) && $countryid!=''){ echo $countryid; }else{ echo "0"; } ?>';
    $( "#sortable" ).sortable({
        appendTo: "parent",
      axis: false,
