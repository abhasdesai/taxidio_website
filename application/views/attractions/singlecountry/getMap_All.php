<div class="sidebar col-md-4 scrollbar-inner">
 ...
 <div class="col-md-12 inner-links">
  ...
  <div class="col-md-4 attractions-btn">
   ...
   <div class="col-md-4 attractions-btn">
    <a id="showMySingle" class="link-button modal-link" href="javascript:void(0);" idattr="<?php echo $cityid; ?>" ><i class="fa fa-plus-circle" aria-hidden="true"></i>View Recommendations</a>
   </div>
   <div class="col-md-4 attractions-btn">
             ...
             function buildLocationList(data) {
              for (i = 0; i < data.features.length; i++) {
                ...
                if(currentFeature.isselected==0)
                {
                    ...
                    linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addInnerAttractionSingle(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                }
                ...
                if(currentFeature.isselected==1)
                {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteInnerAttractionSingle(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                }
...
$("#showMySingle").click(function(){
  $.ajax({
        url: '<?php echo site_url("getUserAttractionsOfSingleCountry") ?>',
        type: 'POST',
        data: 'id='+$(this).attr('idattr')+'&uniqueid='+$('#uid').val(),
        beforeSend: function(){
             $.LoadingOverlay("show");
