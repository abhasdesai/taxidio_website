 ...
 <div class="inner-mainview container">
  ...
  <div class="row">
          ...
          <?php for($i=0;$i<count($countries)-1;$i++){ ?>
              <li class="<?php if($i==0){ echo 'main-li-active'; } ?>" id="<?php echo 'multi'.$i ?>" onClick="getDataForNewCountry(this.id,'<?php echo md5($countries[$i]['country_id']);?>','<?php echo $countries[$i]['country_name'];?>')">
                <?php echo $countries[$i]['country_name'];?>
              </li>
              <?php if($i==0){ ?>
                 <input type='hidden' id='first_country_name' value='<?php echo $countries[$i]['country_name'];?>'>
                <?php
            }
             } ?>
...
<?php } ?>
   <div class="row">
          ...
          <ul id="sortable" class="multicountry-x">


            <?php $c=0; foreach($attractioncities as $list){
              $c++;
         ...
         <input type="hidden" id="coid" name="coid" value="<?php echo $countryid; ?>"/>
           ...
           <div class="col-md-12 inner-links">
            ...
            <div class="col-md-4 attractions-btn">
             ...
             <?php if($this->session->userdata('fuserid')!=''){ ?>
              ...
              <a class="link-button modal-link" href="<?php echo site_url('save-multi-itinerary').'/'.$this->uri->segment(2).'/'.$this->uri->segment(3) ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Save</a>
  ...
  <div class="row button-collections">
    ...
    <?php $param=urlencode($basiccityname).'/'.$longitude.'/'.$latitude ?>
      <ul class="button-ul">
        ...
        <li><a href="<?php echo site_url('showHotelsOfMultiCountries').'/'.$countryid_encrypt; ?>" id="hotellink" class="link-button">Hotel Bookings<i class="fa fa-hand-o-right" aria-hidden="true"></i></a></li>
        ...
        <?php } ?>
         ...
         <li><a id="viator_city_name" target="_blank"  class="link-button ">Viator<i class="fa fa-hand-o-right" aria-hidden="true"></i></a></li>
...
<script>
  ...
  $(document).ready(function(){
    var city_name = $("#first_country_name").val();
...
<div id="mapModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php echo form_open('',array('id'=>'addNewActivityMultiForm')); ?>
    ...
    <div class="modal-content">
     ...
     ?>
      ...
      <div class="mainform <?php echo $dropdown; ?>" id="morecities">
       <?php echo form_open('',array('id'=>'addNewCityFormMultiCountry')); ?>
