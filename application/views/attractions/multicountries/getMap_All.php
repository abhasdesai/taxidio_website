               ...
               var listings = document.getElementById('listings');
                ...
                else
                {
                  ...
                  if(currentFeature.isselected==0)
                  {
                      ...
                      linkadd.innerHTML = '<i class="fa fa-plus" aria-hidden="true" onclick="addMultiAttraction(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                  }
                  ...
                  if(currentFeature.isselected==1)
                  {
                    ...
                    linkdel.innerHTML = '<i class="fa fa-trash-o" aria-hidden="true" onclick="deleteMultiAttraction(\'' + prop.attractionid + '\',\'' + prop.cityid + '\')"></i>';
                 }
