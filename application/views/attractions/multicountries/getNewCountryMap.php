...
<?php } ?>
 ...
 <div class="row">
     ...
     <?php } ?>
         ...
         <input type="hidden" id="coid" name="coid" value="<?php echo $basic['country_id']; ?>"/>
    </div>
              ...
              <div class="sidebar col-md-4 scrollbar-inner">
                 ...
                 <div class="col-md-12 inner-links">
                  ...
                  <div class="col-md-4 attractions-btn">
                    ...
                    <a class="link-button modal-link" href="<?php echo site_url('save-multi-itinerary').'/'.$uid.'/'.$secretkey; ?>"><i class="fa fa-plus-circle" aria-hidden="true"></i>Save</a>
                <?php } else { ?>
...
$(document).ready(function(){
     ...
     $( "#sortable" ).sortable({
        ...
        update: function (event, ui) {
              ...
              $.ajax({
                  data: data+'&uniqueid='+$('#uid').val()+'&coid='+coid,
                  type: 'POST',
                  url: '<?php echo site_url("saveMultiCountryXOrder") ?>',
                  beforeSend: function(){
                     $.LoadingOverlay("show");
                  },
                  complete: function(){
