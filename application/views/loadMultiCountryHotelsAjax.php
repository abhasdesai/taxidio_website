...
<input type="hidden" id="postcountryid" value="<?php echo $postcountryid; ?>"/>
<input type="hidden" id="postuniqueid" value="<?php echo $uniqueid; ?>"/>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var country='<?php if(isset($countrynm) && $countrynm!=""){ echo $countrynm; }  ?>';
        if(country!='')
        {
            $("#connm").text(country);
        }
