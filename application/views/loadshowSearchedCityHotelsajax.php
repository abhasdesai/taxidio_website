...
<input type="hidden" id="postrecommendation" value="<?php echo $postrecommendation; ?>"/>

<?php foreach($hotels as $list){ ?>

<div class="single-hotel-wrapper">
  <div class="col-md-12 no-padding hotel-name">
      <h3><a href="<?php echo $list['hotel_url'].'?aid=1219471'; ?>" class="" target="_blank"><?php echo $list['hotel_name']; ?></a></h3>
    </div>
...
<div class="col-md-12" align="center">
 ...
 $(document).ready(function(){
         ...
         if(cityimage!="")
         {
            ...
            $("#cityhotelnm").html("HOTELS IN "+cityname);
