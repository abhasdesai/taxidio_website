<?php
	...
	function updateOther($city_id,$longitude,$latitude,$tags)
	{
		...
		if($Q->num_rows()>0)
		{
			updateOtherFiles($Q->result_array(),2,'relaxationspa',$tags,$city_id,$longitude,$latitude);
		}
		...
		if($Q->num_rows()>0)
		{
			updateOtherFiles($Q->result_array(),3,'restaurant',$tags,$city_id,$longitude,$latitude);
		}
		...
		if($Q->num_rows()>0)
		{
			updateOtherFiles($Q->result_array(),5,'sport',$tags,$city_id,$longitude,$latitude);
		}
		...
		if($Q->num_rows()>0)
		{
			updateOtherFiles($Q->result_array(),4,'stadium',$tags,$city_id,$longitude,$latitude);
		}

	}

	function updateOtherFiles($rdata,$category,$filep,$tags,$city_id,$longitude,$latitude)
	{
			$CI = &get_instance();
			$c=0;
