...
class Users {
	public $table_name = 'ftn_mst_users';
	
	function __construct(){
		//database configuration
		$dbServer = 'localhost'; //Define database server host
		$dbUsername = 'eintellig_demofitness'; //Define database username
		$dbPassword = 'sTI0Xy9[h)tn'; //Define database password
		$dbName = 'eintellig_demofitness'; //Define database name
